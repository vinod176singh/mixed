drop table if exists #icd9_icd10_pat;
select distinct a.pat_id into #icd9_icd10_pat from 
(select distinct pat_id  from pharmetrics.psc_claims where
(diag_admit = 'K8301' or diag1 ='K8301' or diag2 ='K8301' or diag3 ='K8301' or diag4 ='K8301' or diag5 ='K8301' or diag6 ='K8301' or diag7 ='K8301' or diag8 ='K8301' or diag9 ='K8301' or diag10 ='K8301' or diag11 ='K8301' or diag12 ='K8301')) a
inner join 
(select distinct pat_id from pharmetrics.psc_claims where
(diag_admit = '5761' or diag1 ='5761' or diag2 ='5761' or diag3 ='5761' or diag4 ='5761' or diag5 ='5761' or diag6 ='5761' or diag7 ='5761' or diag8 ='5761' or diag9 ='5761' or diag10 ='5761' or diag11 ='5761' or diag12 ='5761')) b on  a.pat_id =b.pat_id

select date_trunc('month',from_dt),count(distinct pat_id) as pat_cnt from(
...
select a.pat_id ,date_trunc('month',min(from_dt)) as from_dt from pharmetrics.psc_claims a
where pat_id not in (select pat_id from #icd9_icd10_pat) and (diag_admit = 'K8301' or diag1 ='K8301' or diag2 ='K8301' or diag3 ='K8301' or diag4 ='K8301' or diag5 ='K8301' or diag6 ='K8301' or diag7 ='K8301' or diag8 ='K8301' or diag9 ='K8301' or diag10 ='K8301' or diag11 ='K8301' or diag12 ='K8301') 
and (ndc in (select distinct ndc from pharmetrics.ndc_codes where prod_custom_lvl1_desc='PSC') or
